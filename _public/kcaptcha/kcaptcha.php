...
function captcha_html($class="captcha")
{
	...
	$html .= "\n".'<span class="captcha_area">';
	$html .= "\n".'<img src="" alt="" id="captcha_img">';
    $html .= "\n".'<button type="button" id="captcha_reload" style="display:inline-block;padding:0 .5em;background:#efefef;border:1px solid #eee;"><span style="font-size:0.8em">새로고침</span></button>';
	$html .= "\n".'</span>';

	$html .= "\n".'<span class="captcha_input_area">';
    $html .= '<input type="text" name="captcha_key" id="captcha_key" required class="captcha_box required" size="6" maxlength="6" style="width:8em"></span>';
