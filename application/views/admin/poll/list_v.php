...
<li><a href="/baskS1te/poll">설문관리</a></li>
        ...
        <div class="table-responsive board-list mt10">
        	<table class="table table-bordered table-striped table-hover table-center">
        		...
        		<tbody>
        			...
        			<td><a class="link" href="/backS1te/poll/update/<?php echo $lt -> pl_idx; ?>"><?php echo $lt -> pl_subject; ?></a></td>
        			<td><?php echo $lt -> pl_is_view == 0 ? "NO":"YES" ; ?></td>
					<td><?php echo $lt -> pl_question_count; ?></td>
        			<td><?php echo date("Y-m-d", strtotime($lt -> pl_regdate)); ?></td>
        			</tr>
        			<?php } ?>
