...
<div class="panel panel-primary">
	...
	<div class="panel-body" id="board-content">
        ...
        <div class="board_cate_area clearfix">
        	<a href="?sca=" class="col-xs-6 col-md-2 btn <?php echo $this->sca == "" ? "btn-primary": "btn-default" ?>"   >전체</a>
        	...
        	?>
        	<a href="?sca=<?php echo $category -> bc_idx ?>" class="col-xs-6 col-md-2 btn <?php echo $is_selected ?>" ><?php echo $category -> bc_name ?></a>
        	<?php } ?>
        </div>
        <?php } ?>
        <!-- //board_cate_area -->
        ...
        <div class="table-responsive board-list mt10">
        	<table class="table table-bordered table-striped table-hover table-center">
        		...
        		<tbody>
        			...
        			<td><?php echo $lt-> bo_is_view ? '<span style="color:#337ab7" class="glyphicon glyphicon-eye-open" aria-hidden="true"></span><span class="skip">ON</span>' : '<span style="color:#da2724" class="glyphicon glyphicon-eye-close" aria-hidden="true"></span><span class="skip">OFF</span>' ?></td>
        			</tr>
        			<?php } ?>
